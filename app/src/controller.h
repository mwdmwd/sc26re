...
struct controller_battery_report
{
	...
	uint16_t temperature_mc;
	int32_t temperature_estimate_mc;
	uint16_t charger_battery_mv;
	uint16_t source_rating_ma;
	uint16_t requested_input_limit_ma;
	uint16_t effective_input_limit_ma;
	uint16_t requested_vbat_target_mv;
	uint16_t requested_vin_min_mv;
	uint16_t observed_vin_min_mv;
	uint32_t sample_age_ms;
	uint8_t charger_type;
	uint8_t status_flags;
	uint8_t ntc_raw;
	uint8_t current_raw;
	uint8_t fuel_gauge_state;
	uint8_t fault_status;
	uint8_t power_status;
	uint8_t reg17_status;
