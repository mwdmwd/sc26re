...
enum ibex_setting_id
{
	...
	IBEX_SETTING_OLYMPUS_GRIP_TOUCH_PERCENT = SETTING_TRACKPAD_RELATIVE_MODE_MAX_VEL,
	IBEX_SETTING_OLYMPUS_GRIP_RELEASE_PERCENT = SETTING_TRACKPAD_RELATIVE_MODE_INVERT_Y,
